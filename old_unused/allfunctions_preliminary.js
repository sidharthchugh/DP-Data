db.profiles.find({companyStatus: "Preliminary"}).snapshot().forEach(
  function (a) {
...
db.profiles.find({companyStatus: "Preliminary"}).forEach(function(locMultipleValueSeparator) {
...
db.profiles.find({companyStatus: "Preliminary"}).forEach(function(langMultipleValueSeparator) {
   ...
   // print(multipleValueSeparator.languages)
    ...
    db.profiles.find({companyStatus: "Preliminary"}).forEach(function(customersMultipleValueSeparator) {
   ...
   db.profiles.find({companyStatus: "Preliminary"}).forEach(function(strategicPartnersMultipleValueSeparator) {
 ...
 db.profiles.find({companyStatus: "Preliminary"}).forEach(function(product1TechMultipleValueSeparator) {
  ...
  db.profiles.find({companyStatus: "Preliminary"}).forEach(function(product1CategoryMultipleValueSeparator) {
   ...
   db.profiles.find({companyStatus: "Preliminary"}).forEach(function(product2TechMultipleValueSeparator) {
    ...
    db.profiles.find({companyStatus: "Preliminary"}).forEach(function(product2CategoryMultipleValueSeparator) {
...
db.profiles.find({companyStatus: "Preliminary"}).snapshot().forEach(
  function (fproduct2) {
    ...
    fproduct2.product2 =  { 
     ...
     applicationKeyActivities: { type: "multiSelect", typeValues: [ { label: fproduct2.product2.applicationKeyActivities, value: fproduct2.product2.applicationKeyActivities, className: ""} ]},
     applicationKeyResources: { type: "multiSelect", typeValues: [ { label: fproduct2.product2.applicationKeyResources, value: fproduct2.product2.applicationKeyResources, className: ""} ]},
     applicationCostStructure: { type: "multiSelect", typeValues: [ { label: fproduct2.product2.applicationCostStructure, value: fproduct2.product2.applicationCostStructure, className: ""} ]},
...
db.profiles.find({companyStatus: "Preliminary" }).forEach( function(productArray) {
    productArray.products = [productArray.product1, productArray.product2];
    db.profiles.save(productArray);
  });

db.profiles.update({companyStatus: "Preliminary"},{$unset: {product1:1}},{multi: true});
db.profiles.update({companyStatus: "Preliminary"},{$unset: {product2:1}},{multi: true});
